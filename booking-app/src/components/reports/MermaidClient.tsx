...
// =============================================================================
// MermaidClient — the real implementation. Don't import this directly from
// pages; use `Mermaid` from ./Mermaid which wraps this in `next/dynamic` so
// the diagram subsystem only downloads when a chart actually mounts (the
// previous static import pulled this whole file into every report page's
// client chunk list, even diagram-free ones).
//
// The npm `mermaid` package itself is lazy-imported inside the effect below,
// so even this module stays small until a diagram renders.
//
