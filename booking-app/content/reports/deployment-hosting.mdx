...
| **A CareFirst-side webhook to us would have to land over HTTP** | This is the immediate blocker for the <a href="/reports/consultation-outcome-webhook">Consultation Outcome Webhook</a> proposal |
