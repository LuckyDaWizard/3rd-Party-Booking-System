...
<Callout title="vitals — speculative extension, not yet in your schema" variant="warn">
The <code>user.vitals</code> block is <strong>not</strong> defined in your current TypeScript interface or Postman collection. We send it speculatively starting 2026-06-03 — if your endpoint silently ignores unknown fields (most do), nothing changes for you. When you extend your schema to consume vitals, no code change is required on our side. If your endpoint <strong>rejects</strong> unknown fields under strict validation, let us know and we'll either gate behind a flag or remove until you're ready.
</Callout>
