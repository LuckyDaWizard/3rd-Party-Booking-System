...
|---|---|---|
| HTTPS | TLS for transport security | **Required** — live since 2026-06-03 (Let's Encrypt via Traefik) with HSTS since 2026-06-08; the receiving-end security prerequisite for this webhook is now met (see [Deployment](/reports/deployment-hosting)) |
