...
- The system URL: `https://bookings.carefirst.co.za`
- Your **6-digit PIN**
...
flowchart LR
    ...
    C --> E[Verification<br/>review + nurse PIN]
...
6. **Step 4 — Verification**: review everything. If anything's wrong, click the section to edit. If your client requires nurse verification, a PIN modal will pop up — enter the on-duty nurse's PIN.
7. **Step 5 — Payment**: this is the one place the flow branches. You'll see one of:
...
8. **Vitals** — BP, glucose, temp, O₂, heart rate. Skip-able per client; if your client skips this, you'll jump straight to T&Cs.
9. **T&Cs** — the patient reads and accepts. The system records the timestamp.
10. **Start Consult** — if you're a manager/admin, this fires automatically when T&Cs are accepted. CareFirst opens in a new tab and the patient is in their hands.
